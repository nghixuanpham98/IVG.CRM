        ...
        $.ajax({
            ...
            success: function (rs) {
                ...
                for (var i = 0; i < rs.Data.length; i++) {
                    ...
                    html += `<td class="table-detail" onclick="Detail('${rs.Data[i].ID}')">${(rs.Data[i].FirstName != null ? rs.Data[i].FirstName : '')} ${(rs.Data[i].LastName != null ? rs.Data[i].LastName : '')}</td>`;
...
function NoteUpdate() {
    try {
        ...
        $.ajax({
            url: common_api_url + 'Lead/NoteUpdate',
            type: "POST",
            data: frmData,
            cache: false,
            contentType: false,
...
function NoteDelete(ID) {
    try {
        ...
        $.ajax({
            url: common_api_url + 'Lead/NoteDelete',
            type: "POST",
            data: data,
            success: function (rs) {
                NoteList();
...
function NoteDown(ID) {
    try {
        ...
        $.ajax({
            url: common_api_url + 'Lead/NoteDown',
            type: "POST",
            data: data,
            success: function (rs) {
...
function NoteList() {
    try {
        ...
        $.ajax({
            url: common_api_url + 'Lead/NoteList',
            type: "POST",
            data: data,
            success: function (rs) {
                $('#tblAttach').html('');
...
function NoteDeleteFile(ID) {
    try {
        ...
        $.ajax({
            url: common_api_url + 'Lead/NoteDeleteFile',
            type: "POST",
            data: data,
            success: function (rs) {
